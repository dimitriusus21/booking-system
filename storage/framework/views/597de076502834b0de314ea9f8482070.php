        ...
        <div class="glass-auth-card">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="glass-input <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>"
                           name="name" value="<?php echo e(old('name')); ?>" placeholder="Иван Иванов" required autofocus>
...
unset($__errorArgs, $__bag); ?>"
                           name="email" value="<?php echo e(old('email')); ?>" placeholder="name@example.com" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <select class="glass-select" name="role" id="roleSelect">
                        <option value="client" <?php echo e(old('role') === 'client' ? 'selected' : ''); ?>>Я клиент (ищу услуги)</option>
                        <option value="organization" <?php echo e(old('role') === 'organization' ? 'selected' : ''); ?>>Я организация (предоставляю услуги)</option>
                    </select>

                    <div class="hint-box" id="roleHint">
                        <i class="bi bi-info-circle"></i>
                        <span id="hintText">
                            <?php if(old('role') === 'organization'): ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="auth-footer">
                ...
                <a href="<?php echo e(route('login')); ?>" class="auth-link ms-1">Войти</a>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OSPanel\home\booking-system.local\resources\views/auth/register.blade.php ENDPATH**/ ?>