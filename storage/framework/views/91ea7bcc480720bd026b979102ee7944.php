        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-md-3">
                <div class="stat-card" style="--stat-color: var(--neon-warning); --stat-rgb: 255, 209, 102; --delay: 4;">
                    ...
                    <h3 class="stat-value"><?php echo e($stats['pending_orgs']); ?></h3>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="action-card">
                    ...
                    <div class="d-flex flex-column gap-3">
                        <a href="<?php echo e(route('admin.users')); ?>" class="btn-action-glow">
                            <i class="bi bi-people"></i> Управление пользователями
                        </a>
                        <a href="<?php echo e(route('admin.organizations')); ?>" class="btn-action-glow">
                            <i class="bi bi-buildings"></i> Управление организациями
                        </a>
                        <a href="<?php echo e(route('admin.categories')); ?>" class="btn-action-glow">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OSPanel\home\booking-system.local\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>