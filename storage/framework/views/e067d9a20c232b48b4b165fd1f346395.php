<?php $__env->startSection('title', 'Оставить отзыв'); ?>
        ...
        <div class="glass-panel">
            ...
            <div class="service-info-card">
                ...
                <div>
                    ...
                    <h5 class="service-name"><?php echo e($booking->service->title); ?></h5>
                    <div class="small" style="color: var(--accent-primary); font-weight: 700;"><?php echo e($booking->service->organization->name); ?></div>
                </div>
            </div>

            <form action="<?php echo e(route('reviews.store', $booking)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="rating-wrapper">
                    ...
                    <div class="stars-container">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            <input type="radio" name="rating" id="rating<?php echo e($i); ?>" value="<?php echo e($i); ?>" class="d-none" <?php echo e(old('rating') == $i ? 'checked' : ''); ?> required>
                            <label class="star-item <?php echo e(old('rating') >= $i ? 'active' : ''); ?>" for="rating<?php echo e($i); ?>" data-value="<?php echo e($i); ?>">
                                <i class="bi bi-star<?php echo e(old('rating') >= $i ? '-fill' : ''); ?>" id="star<?php echo e($i); ?>"></i>
                            </label>
                        <?php endfor; ?>
                    </div>
...
$message = $__bag->first($__errorArgs[0]); ?> <div class="error-message justify-content-center"><i class="bi bi-exclamation-circle"></i> Пожалуйста, выберите оценку</div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="input-group-custom">
                    ...
                    <textarea name="comment" id="comment" class="glass-textarea"
                              ...
                              required minlength="10"><?php echo e(old('comment')); ?></textarea>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="error-message m-0"><i class="bi bi-exclamation-triangle"></i> Текст слишком короткий</span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    </div>
                ...
                <div class="pt-2">
                    ...
                    <a href="<?php echo e(route('my-bookings')); ?>" class="btn-cancel-link">Вернуться назад</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OSPanel\home\booking-system.local\resources\views/reviews/create.blade.php ENDPATH**/ ?>