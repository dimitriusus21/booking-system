            ...
            <div class="col-lg-9">
                <div class="page-header">
                    ...
                    <p style="color: var(--text-description); margin-top: 0.5rem; font-size: 1.1rem;">
                        Обновите параметры услуги <strong><?php echo e($service->title); ?></strong>
                    </p>
                </div>
                ...
                <div class="glass-panel">
                    ...
                    <form action="<?php echo e(route('organization.services.update', $service)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                   name="title" id="title" value="<?php echo e(old('title', $service->title)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                      name="description" id="description" required><?php echo e(old('description', $service->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                           name="price" id="price" value="<?php echo e(old('price', $service->price)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                           name="duration" id="duration" value="<?php echo e(old('duration', $service->duration)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                           name="max_days_ahead" id="max_days_ahead" value="<?php echo e(old('max_days_ahead', $service->max_days_ahead ?? 30)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                           ...
                                           value="<?php echo e(old('cancellation_deadline_hours', $service->cancellation_deadline_hours ?? 2)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="neon-switch-wrapper mb-2 mt-4">
                            <label class="neon-switch">
                                ...
                                <input type="checkbox" name="is_active" id="is_active" value="1" <?php echo e(old('is_active', $service->is_active) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OSPanel\home\booking-system.local\resources\views/organization/edit.blade.php ENDPATH**/ ?>