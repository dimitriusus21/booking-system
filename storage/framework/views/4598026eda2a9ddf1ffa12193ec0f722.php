<?php $__env->startSection('title', 'Управление услугами'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="dark-page-wrapper">
        ...
        <div class="page-header">
            ...
            <a href="<?php echo e(route('organization.services.create')); ?>" class="btn-add-glow">
                ...
                <div class="table-responsive">
                    <table class="glass-table">
                        ...
                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <div class="service-title-main"><?php echo e($service->title); ?></div>
                                    <span class="cat-badge"><?php echo e($service->category->name ?? 'Без категории'); ?></span>
                                </td>
                                <td><span class="price-tag"><?php echo e(number_format($service->price, 0, '', ' ')); ?> ₽</span></td>
                                <td style="color: var(--text-secondary);">
                                    <i class="bi bi-clock me-1"></i> <?php echo e($service->duration); ?> мин
                                </td>
                                <td>
                                    <div class="action-btn-group justify-content-end">
                                        <a href="<?php echo e(route('organization.schedule.index', $service->id)); ?>" class="btn-action-glass btn-schedule" title="Расписание">
                                            <i class="bi bi-calendar-week"></i>
                                        </a>
                                        <a href="<?php echo e(route('organization.services.edit', $service->id)); ?>" class="btn-action-glass btn-edit" title="Редактировать">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="<?php echo e(route('organization.services.destroy', $service->id)); ?>" method="POST" onsubmit="return confirm('Удалить эту услугу навсегда?')">
        ...
        <?php else: ?>
            <div class="glass-panel empty-state">
                ...
                <a href="<?php echo e(route('organization.services.create')); ?>" class="btn-add-glow mt-3">Создать услугу</a>
            </div>
        <?php endif; ?>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OSPanel\home\booking-system.local\resources\views/organization/services-list.blade.php ENDPATH**/ ?>