        ...
        <div class="row g-5">
            <div class="col-lg-4">
                <div class="profile-sidebar">
                    <div class="text-center">
                        ...
                        <h2 class="fw-bold text-white mb-2"><?php echo e($organization->name); ?></h2>
                        <span class="badge bg-primary bg-opacity-20 text-white rounded-pill px-3 py-2 border border-primary border-opacity-50">
                            <?php echo e($organization->category->name ?? 'Услуги'); ?>

                        </span>
                    </div>

                    <div class="my-5 text-center">
                        <div class="rating-giant"><?php echo e(number_format($organization->average_rating, 1)); ?></div>
                        <div class="text-warning fs-4 mb-2">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <?php echo $i <= round($organization->average_rating) ? '★' : '<span style="opacity: 0.2">☆</span>'; ?>

                            <?php endfor; ?>
                        </div>
                        <p class="text-bright-muted small mb-4">На основе <?php echo e($organization->reviews_count); ?> мнений</p>
                            ...
                            <?php if($totalReviews > 0): ?>
                                <?php for($stars = 5; $stars >= 1; $stars--): ?>
                                    ...
                                    <div class="rating-row">
                                        <span style="min-width: 25px; color: #fff;"><?php echo e($stars); ?> <i class="bi bi-star-fill" style="font-size: 0.7rem;"></i></span>
                                        <div class="progress-container flex-grow-1">
                                            <div class="rating-bar-container">
                                                <div class="rating-bar-fill" style="width: <?php echo e($percent); ?>%"></div>
                                            </div>
                                        </div>
                                        <span style="min-width: 20px; color: #fff;" class="text-end"><?php echo e($count); ?></span>
                                    </div>
                                <?php endfor; ?>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="contact-box mt-5">
                        ...
                        <div class="contact-item">
                            ...
                            <span class="fw-bold"><?php echo e($organization->address ?? 'Адрес не указан'); ?></span>
                        </div>
                        <a href="tel:<?php echo e($organization->phone); ?>" class="contact-item">
                            <i class="bi bi-telephone-fill"></i>
                            <span class="fw-bold"><?php echo e($organization->phone ?? 'Связь не указана'); ?></span>
                        </a>
                        <a href="mailto:<?php echo e($organization->email); ?>" class="contact-item">
                            <i class="bi bi-envelope-fill"></i>
                            <span class="fw-bold"><?php echo e($organization->email ?? 'Email не указан'); ?></span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                                ...
                                <div class="col-12">
                                    <div class="service-smart-card">
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            <div class="pe-3">
                                                <h5 class="fw-bold text-white mb-2"><?php echo e($service->title); ?></h5>
                                                <p style="color: var(--text-description); line-height: 1.6;" class="small mb-0"><?php echo e(Str::limit($service->description, 180)); ?></p>
                                            </div>
                                            <div class="text-end flex-shrink-0">
                                                <div class="service-price"><?php echo e(number_format($service->price, 0, '', ' ')); ?> ₽</div>
                                                <span class="service-duration"><i class="bi bi-clock me-1"></i> <?php echo e($service->duration); ?> мин</span>
                                            </div>
                                        </div>
                                        <div class="mt-3 pt-3 border-top border-white border-opacity-10 d-flex justify-content-end">
                                            <a href="<?php echo e(route('services.show', $service)); ?>" class="btn-booking px-5">Выбрать время</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="section-card">
                    ...
                    <?php $orgReviews = $organization->reviews()->with(['client', 'booking.service'])->latest()->get(); ?>

                    <?php if($orgReviews->count() > 0): ?>
                        <div class="reviews-list">
                            <?php $__currentLoopData = $orgReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="review-item">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="fw-bold text-white fs-5"><?php echo e($review->client->name ?? 'Пользователь'); ?></div>
                                            <span class="verified-badge"><i class="bi bi-patch-check-fill me-1"></i> Визит подтвержден</span>
                                        </div>
                                        <div class="text-bright-muted fw-bold"><?php echo e($review->created_at->format('d.m.Y')); ?></div>
                                    </div>
                                    ...
                                    <div class="mb-3 d-flex align-items-center gap-3">
                                        ...
                                        <div class="badge bg-white bg-opacity-10 text-white fw-bold px-3 py-2">Услуга: <?php echo e($review->booking->service->title ?? 'Удалена'); ?></div>
                                    </div>

                                    <p style="color: var(--text-description); font-size: 1.05rem;" class="mb-0">«<?php echo e($review->comment); ?>»</p>
                                    ...
                                    <?php if($review->reply): ?>
                                        <div class="reply-accent-box">
                                            ...
                                            <p class="mb-0 text-white fw-bold"><?php echo e($review->reply); ?></p>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OSPanel\home\booking-system.local\resources\views/organizations/show.blade.php ENDPATH**/ ?>