                        ...
                        <table class="glass-table">
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><span class="badge bg-secondary rounded-pill" style="background: rgba(255,255,255,0.1)!important;"><?php echo e($cat->services_count); ?></span></td>
                                    <td class="text-end">
                                        <form action="<?php echo e(route('admin.categories.delete', $cat)); ?>" method="POST" onsubmit="return confirm('Вы уверены, что хотите удалить эту категорию?')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OSPanel\home\booking-system.local\resources\views/admin/categories.blade.php ENDPATH**/ ?>