<?php $__env->startSection('title', 'Панель организации'); ?>
    ...
    <div class="dark-page-wrapper container py-4">
        ...
        <?php if(!$organization): ?>
            <div class="neon-alert-warning">
                ...
                <a href="<?php echo e(route('organization.profile.create')); ?>" class="btn-alert-action">Заполнить профиль <i class="bi bi-arrow-right ms-1"></i></a>
            </div>
        <?php endif; ?>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-6 col-lg-3">
                <div class="stat-card" style="--stat-color: var(--accent-primary); --stat-rgb: 0, 102, 255; --delay: 1;">
                    ...
                    <h4 class="stat-value text-truncate" style="font-size: 1.5rem;" title="<?php echo e($organization->name ?? auth()->user()->name); ?>">
                        <?php echo e($organization->name ?? auth()->user()->name); ?>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="stat-card" style="--stat-color: var(--neon-info); --stat-rgb: 0, 210, 255; --delay: 2;">
                    ...
                    <h2 class="stat-value"><?php echo e($servicesCount); ?></h2>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="stat-card" style="--stat-color: var(--neon-success); --stat-rgb: 6, 214, 160; --delay: 3;">
                    ...
                    <h2 class="stat-value"><?php echo e($todayBookings); ?></h2>
                </div>
            </div>

            <div class="col-md-6 col-lg-3">
                <a href="<?php echo e(route('organization.reviews.index')); ?>" style="text-decoration: none; display: block; height: 100%;">
                    <div class="stat-card" style="--stat-color: var(--neon-warning); --stat-rgb: 255, 209, 102; --delay: 4;">
                        ...
                        ?>
                        <h2 class="stat-value"><?php echo e($reviewsCount); ?></h2>
                        <?php if($unansweredCount > 0): ?>
                            <div class="urgent-badge">Ждут ответа: <?php echo e($unansweredCount); ?></div>
                        <?php else: ?>
            ...
            <div class="col-xl-5">
                <div class="glass-panel">
                    <div class="panel-header">
                        ...
                        <a href="<?php echo e(route('organization.services.create')); ?>" class="btn-panel-action"><i class="bi bi-plus-lg"></i> Добавить</a>
                    </div>
                        ...
                        <div class="services-list">
                            <?php $__currentLoopData = $recentServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="service-item">
                                    <div>
                                        <div class="service-item-title"><?php echo e($service->title); ?></div>
                                        <div class="service-item-meta"><?php echo e(number_format($service->price, 0, '', ' ')); ?> ₽ <span class="mx-1">•</span> <i class="bi bi-clock"></i> <?php echo e($service->duration); ?> мин</div>
                                    </div>
                                    <div class="d-flex gap-2">
                                        <a href="<?php echo e(route('organization.schedule.index', $service->id)); ?>" class="btn-icon-glass schedule" title="Настроить расписание"><i class="bi bi-calendar-week"></i></a>
                                        <a href="<?php echo e(route('organization.services.edit', $service->id)); ?>" class="btn-icon-glass edit" title="Редактировать услугу"><i class="bi bi-pencil"></i></a>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <div class="text-center mt-3">
                            <a href="<?php echo e(route('organization.services.index')); ?>" class="link-view-all">
                                ...
                                <div class="booking-item">
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            <div class="booking-client"><i class="bi bi-person-circle"></i> <?php echo e($booking->client->name); ?></div>
                                        ...
                                        <div class="booking-service"><?php echo e($booking->service->title); ?></div>
                                        <div class="booking-date">
                                            <span><i class="bi bi-calendar-event"></i> <?php echo e(\Carbon\Carbon::parse($booking->booking_date)->format('d.m.Y')); ?></span>
                                            <span><i class="bi bi-clock"></i> <?php echo e(\Carbon\Carbon::parse($booking->start_time)->format('H:i')); ?></span>
                                        </div>

                                        <?php if($booking->status === 'pending'): ?>
                                            <div class="action-btns-group border-top border-secondary border-opacity-10 pt-3 mt-3">
                                                <form action="<?php echo e(route('bookings.accept', $booking)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                                    <button type="submit" class="btn-action-solid btn-accept"><i class="bi bi-check-lg"></i> Подтвердить запись</button>
                                                </form>
                                                <form action="<?php echo e(route('bookings.reject', $booking)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                        ...
                                        <?php elseif($booking->status === 'confirmed'): ?>
                                            <div class="action-btns-group border-top border-secondary border-opacity-10 pt-3 mt-3">
                                                <form action="<?php echo e(route('bookings.complete', $booking)); ?>" method="POST" class="w-100">
                                                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OSPanel\home\booking-system.local\resources\views/organization/dashboard.blade.php ENDPATH**/ ?>