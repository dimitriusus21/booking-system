...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Booking System'); ?></title>
    ...
    <div class="container">
        ...
        <?php if(session('error')): ?>
            <div class="alert alert-danger alert-dismissible fade show shadow-sm" role="alert">
                <i class="bi bi-exclamation-triangle-fill me-2 text-danger"></i><?php echo e(session('error')); ?>
        ...
        <?php if(session('warning')): ?>
            <div class="alert alert-warning alert-dismissible fade show shadow-sm" role="alert">
                <i class="bi bi-exclamation-circle-fill me-2 text-warning"></i><?php echo e(session('warning')); ?>
...
<?php /**PATH C:\OSPanel\home\booking-system.local\resources\views/layouts/app.blade.php ENDPATH**/ ?>