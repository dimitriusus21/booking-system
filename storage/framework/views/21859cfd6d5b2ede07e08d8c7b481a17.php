<?php $__env->startSection('title', 'Мастер управления временем'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="dark-page-wrapper">
        ...
        <div class="page-header">
            ...
            <a href="<?php echo e(route('organization.schedule.index', $service->id)); ?>" class="btn-back-glass">
        ...
        <?php if($slotsByDate->count() > 0): ?>
            <div class="accordion glass-accordion" id="slotsAccordion">
                <?php $__currentLoopData = $slotsByDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $slots): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="accordion-item shadow-lg">
                        <div class="accordion-header">
                            <button class="accordion-button <?php echo e($loop->first ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo e($loop->index); ?>">
                                <i class="bi bi-calendar-event-fill me-3 text-primary"></i>
                                <?php echo e(\Carbon\Carbon::parse($date)->locale('ru')->translatedFormat('d F Y')); ?>
                                ...
                                <span class="badge rounded-pill bg-primary bg-opacity-10 text-primary ms-3" style="font-size: 0.75rem; border: 1px solid rgba(0,102,255,0.3); font-weight: 800;">
                                    <?php echo e($slots->count()); ?> СЛОТОВ
                                </span>
                            </button>

                            <form action="<?php echo e(route('organization.slots.destroyDay', ['serviceId' => $service->id, 'date' => $date])); ?>" method="POST" onsubmit="return confirm('Удалить этот день?')">
                        ...
                        <div id="collapse<?php echo e($loop->index); ?>" class="accordion-collapse collapse <?php echo e($loop->first ? 'show' : ''); ?>" data-bs-parent="#slotsAccordion">
                                    ...
                                    <?php $__currentLoopData = $slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="slot-chip">
                                            ...
                                            <div class="slot-actions">
                                                <button type="button" class="btn-slot-action btn-slot-edit" data-bs-toggle="modal" data-bs-target="#editSlot<?php echo e($slot->id); ?>" title="Редактировать время">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>

                                                <form action="<?php echo e(route('organization.slots.destroy', $slot->id)); ?>" method="POST" onsubmit="return confirm('Удалить этот интервал?');">
                                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
        ...
        <?php else: ?>
            <div class="glass-panel text-center py-5 shadow-lg">
                ...
                <a href="<?php echo e(route('organization.schedule.index', $service->id)); ?>" class="btn btn-primary rounded-pill px-5 py-3 mt-3 fw-bold">
    ...
    <?php $__currentLoopData = $slotsByDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $slots): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $__currentLoopData = $slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="modal fade glass-modal" id="editSlot<?php echo e($slot->id); ?>" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo e(route('organization.slots.update', $slot->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                            <div class="modal-body p-4">
                                <div class="row g-3 mb-4">
                                    <div class="col-6">
                                        <label class="text-white-50 small text-uppercase fw-bold mb-2 d-block">Начало приема</label>
                                        <input type="time" name="start_time" class="glass-input" value="<?php echo e(\Carbon\Carbon::parse($slot->start_time)->format('H:i')); ?>" required>
                                    </div>
                                    <div class="col-6">
                                        <label class="text-white-50 small text-uppercase fw-bold mb-2 d-block">Завершение</label>
                                        <input type="time" name="end_time" class="glass-input" value="<?php echo e(\Carbon\Carbon::parse($slot->end_time)->format('H:i')); ?>" required>
                                    </div>
                                </div>

                                <div class="shift-notice">
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input" type="checkbox" name="shift_others" id="shift<?php echo e($slot->id); ?>" value="1" checked>
                                        <label class="form-check-label fw-bold text-white ms-2" for="shift<?php echo e($slot->id); ?>" style="cursor:pointer">
                                            Умный сдвиг очереди
                                        </label>
                                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OSPanel\home\booking-system.local\resources\views/organization/slots.blade.php ENDPATH**/ ?>