    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-lg-center gap-1">
                ...
                <li class="nav-item">
                    <a class="nav-link glass-nav-link" href="{{ route('services.index') }}">
                        <i class="bi bi-grid"></i> Каталог услуг
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link glass-nav-link" href="{{ route('organizations.index') }}">
                ...
                @auth
                    ...
                    @if(auth()->user()->isAdmin())
                        <li class="nav-item">
                            <a class="nav-link glass-nav-link nav-admin-link" href="{{ route('admin.dashboard') }}">
                    ...
                    @if(auth()->user()->isOrganization())
                        <li class="nav-item">
                            <a class="nav-link glass-nav-link" href="{{ route('organization.dashboard') }}">
                                <i class="bi bi-speedometer2"></i> Рабочая панель
                            </a>
                        </li>
                    @else
                        <li class="nav-item">
                            <a class="nav-link glass-nav-link" href="{{ route('my-bookings') }}">
                                <i class="bi bi-journal-bookmark"></i> Мои записи
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link glass-nav-link" href="{{ route('my-reviews') }}">
                    ...
                    <li class="nav-item me-lg-2">
                        <a class="nav-link glass-nav-link position-relative" href="{{ route('notifications.index') }}">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link glass-nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <span class="nav-username-text">{{ auth()->user()->name }}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end glass-dropdown">
                            <li>
                                <a class="dropdown-item glass-dropdown-item" href="{{ route('client.dashboard') }}">
                ...
                @else
                    ...
                    <li class="nav-item mt-2 mt-lg-0">
                        <a class="nav-link glass-nav-link btn-nav-login text-center" href="{{ route('login') }}">
                            <i class="bi bi-box-arrow-in-right d-none d-lg-inline-block"></i> Вход
                        </a>
                    </li>
                    <li class="nav-item mt-2 mt-lg-0 ms-lg-2">
                        <a class="nav-link glass-nav-link btn-nav-register text-center" href="{{ route('register') }}">
