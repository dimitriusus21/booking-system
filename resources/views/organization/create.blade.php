                    ...
                    <form action="{{ route('organization.services.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="glass-input @error('title') is-invalid @enderror"
                                   name="title" id="title" value="{{ old('title') }}" placeholder="Например: Мужская стрижка" required autofocus>
                            @error('title')
                        ...
                        <div class="mb-5">
                            ...
                            <textarea class="glass-textarea @error('description') is-invalid @enderror"
                                      name="description" id="description" placeholder="Расскажите клиентам, что входит в эту услугу, какие материалы используются..." required>{{ old('description') }}</textarea>
                            @error('description')
                            <div class="invalid-feedback-neon"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-icon-wrapper">
                                    <input type="number" step="0.01" class="glass-input @error('price') is-invalid @enderror"
                                           name="price" id="price" value="{{ old('price') }}" placeholder="0.00" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-icon-wrapper">
                                    <input type="number" class="glass-input @error('duration') is-invalid @enderror"
                                           name="duration" id="duration" value="{{ old('duration', 60) }}" min="5" step="5" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-icon-wrapper">
                                    <input type="number" class="glass-input @error('max_days_ahead') is-invalid @enderror"
                                           name="max_days_ahead" id="max_days_ahead" value="{{ old('max_days_ahead', 30) }}" min="1">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-icon-wrapper">
                                    <input type="number" class="glass-input @error('cancellation_deadline_hours') is-invalid @enderror"
                                           ...
                                           value="{{ old('cancellation_deadline_hours', 2) }}" min="0">
