            ...
            <div class="review-card">
                <div class="client-info">
                    <div class="client-name">
                        ...
                        {{ $review->client->name ?? 'Неизвестный клиент' }}
                    </div>
                ...
                <div class="service-tag">
                    ...
                    {{ $review->booking->service->title ?? 'Удаленная услуга' }}
                    <span class="opacity-50 mx-1">/</span>
                    {{ \Carbon\Carbon::parse($review->booking->booking_date)->format('d.m.Y') }}
                </div>
                ...
                @else
                    <button class="btn-reply-neon" type="button" data-bs-toggle="collapse" data-bs-target="#replyForm{{ $review->id }}">
