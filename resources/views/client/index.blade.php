    ...
    <div class="homepage">
        ...
        <section class="hero-section">
            ...
            <div class="hero-content">
                ...
                <div class="hero-actions">
                    <a class="hero-btn hero-btn-primary" href="{{ route('services.index') }}">
                    ...
                    @guest
                        <a class="hero-btn hero-btn-secondary" href="{{ route('register') }}">
        ...
        <section class="cta-section">
            <div class="cta-card">
                ...
                <a class="cta-btn" href="{{ route('services.index') }}">
