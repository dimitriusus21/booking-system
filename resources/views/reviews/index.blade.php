...
@section('content')
    ...
    <div class="dark-page-wrapper">
        ...
        <div class="page-header">
            ...
            <a href="{{ route('my-bookings') }}" class="btn-back-glass">
        ...
        @if(session('success'))
            <div class="alert alert-success bg-success bg-opacity-10 border-success border-opacity-25 text-white rounded-4 mb-5 shadow-lg">
                <i class="bi bi-check2-all me-2 text-success fs-4"></i> {{ session('success') }}
            </div>
        @endif
                    ...
                    <div class="col-12">
                        <div class="review-card">
                            <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
                                <div>
                                    ...
                                    <div class="review-date">
                                        ...
                                        {{ \Carbon\Carbon::parse($review->created_at)->locale('ru')->translatedFormat('d F Y') }}
                                    </div>
                                </div>

                                <div class="actions-group">
                                    <a href="{{ route('reviews.edit', $review) }}" class="btn-action-glass btn-edit-neon">
                            ...
                            <div class="service-info">
                                <h2 class="service-title">{{ $review->booking->service->title ?? 'Услуга более недоступна' }}</h2>
                                <a href="{{ route('organizations.show', $review->organization) }}" class="org-link">
                                    <i class="bi bi-building me-1"></i> {{ $review->organization->name }}
                                </a>
                            </div>
        ...
        @else
            <div class="empty-state">
                ...
                <a href="{{ route('my-bookings') }}" class="btn-back-glass d-inline-flex px-5 py-3" style="background: var(--accent-purple);">
